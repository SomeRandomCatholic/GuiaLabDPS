    ...
    <>
      <ScrollView>
        ...
        >
          <View style={styles.vistaModal}>
            <View style={styles.Modal}>
              ...
              <Text>El platillo típico de El Salvador por excelencia!</Text>
              <Button
                title="Cerrar"
                onPress={() => setModalVisiblePupa(!modalVisiblePupa)}
              ></Button>
            </View>
          </View>
        </Modal>
        ...
        >
          <View style={styles.vistaModal}>
            <View style={styles.Modal}>
              <Text style={styles.subtitulo}>Escalar Volcanes</Text>
              <Text>
                El volcán de Izalco es famoso entre los que practican senderismo
              </Text>
              <Button
                title="Cerrar"
                onPress={() => setModalVisibleIzalco(!modalVisibleIzalco)}
              ></Button>
            </View>
          </View>
        </Modal>
        ...
        <View style={styles.contenedor}>
          ...
          <View>
            <TouchableHighlight
              onPress={() => {
                setModalVisiblePupa(!modalVisiblePupa);
              }}
            >
              <Image
          ...
          <View style={styles.listado}>
            ...
            <TouchableHighlight
              onPress={() => {
                setModalVisibleIzalco(!modalVisibleIzalco);
              }}
